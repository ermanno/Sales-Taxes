...
/**
 * Using Fowler's Money pattern to handle currency. Could be extended to handle
 * multiple currencies (USD, EUR, ...). Example in PHP:
 * https://dzone.com/articles/practical-php-patterns/basic/practical-php-patterns-money).
 * 
 * @author ermanno
 *
 */
public class Money implements Comparable<Money> {
    ...
    public Money multiply(Money money) {
        amount = amount.multiply(money.amount);
        return this;
    }
